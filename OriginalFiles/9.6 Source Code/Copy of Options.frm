...
Begin VB.Form Options 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(0)=   "LangStat"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "Command1"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "ChangePW"
      ...
      Tab(2).Control(0)=   "txtLines"
      Tab(2).Control(1)=   "Timer1"
      Tab(2).Control(2)=   "chkURLs"
      Tab(2).Control(3)=   "txtTSFormat"
      Tab(2).Control(4)=   "Frame10"
      Tab(2).Control(5)=   "chkTimestamp"
      Tab(2).Control(6)=   "Label5"
      Tab(2).Control(7)=   "Label3"
      Tab(2).Control(8)=   "lblSample"
      Tab(2).Control(9)=   "Label1"
      Tab(2).ControlCount=   10
      TabCaption(3)   =   "Animations"
      TabPicture(3)   =   "Options.frx":217E
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "tmrDX"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "picTest"
      Tab(3).Control(1).Enabled=   0   'False
      Tab(3).Control(2)=   "cmdTest"
      Tab(3).Control(2).Enabled=   0   'False
      Tab(3).Control(3)=   "cmbDev"
      Tab(3).Control(3).Enabled=   0   'False
      Tab(3).Control(4)=   "chkTimer"
      Tab(3).Control(4).Enabled=   0   'False
      Tab(3).Control(5)=   "txtRefresh"
      Tab(3).Control(5).Enabled=   0   'False
      Tab(3).Control(6)=   "chkMoveAnims"
      ...
      Begin VB.CheckBox chkTimer 
         Caption         =   "Use High Performance Timer for frame accuracy"
         Height          =   255
         Left            =   -74880
         TabIndex        =   67
         Top             =   840
      ...
      Begin VB.TextBox txtRefresh 
         ...
         Width           =   435
      End
      Begin VB.CheckBox chkMoveAnims 
         Caption         =   "Use Move Animations (Requires DirectX7 or higher)"
         Height          =   495
         Left            =   -74880
         TabIndex        =   65
         Top             =   360
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.PictureBox Picture4 
            ...
            Top             =   720
            Width           =   1815
            Begin VB.CommandButton UpdateScan 
               Caption         =   "&Check Version"
               Height          =   375
               Left            =   0
               TabIndex        =   33
               Top             =   120
               WhatsThisHelpID =   10023
               Width           =   1815
            End
         End
      ...
      Begin VB.Label Label6 
         Caption         =   "Frame Time refresh rate:"
         Height          =   255
         Left            =   -74880
         TabIndex        =   68
         Top             =   1260
