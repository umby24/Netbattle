...
Begin VB.Form ChallengeWindow 
   ...
   Begin VB.Frame PTInfo 
      ...
      Begin VB.Image imgBMode 
         Height          =   480
         Left            =   120
         Picture         =   "Copy of Player.frx":1272
         Top             =   1620
         Width           =   480
      End
      ...
      Begin VB.Label Label1 
         Caption         =   $"Copy of Player.frx":1B3C
         Height          =   615
         Left            =   120
         TabIndex        =   12
         Top             =   780
   ...
   Begin VB.Frame RuleFrame 
      ...
      Begin VB.ComboBox TerrainSelector 
         Height          =   315
         ItemData        =   "Copy of Player.frx":1C09
         Left            =   2820
         List            =   "Copy of Player.frx":1C0B
      ...
      Begin VB.ComboBox ModeSelector 
         Height          =   315
         ItemData        =   "Copy of Player.frx":1C0D
         Left            =   120
         List            =   "Copy of Player.frx":1C0F
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   240
         Width           =   2595
...
'    End Select
    ...
    If Not Player(ChallengeNumber).ShowTeam Then
        Select Case Ubers
            Case 1
                lblUbers.Caption = "1 Uber"
                'Me.Caption = Me.Caption & " - 1 Uber"
            Case Is > 1
                lblUbers.Caption = Ubers & " Ubers"
